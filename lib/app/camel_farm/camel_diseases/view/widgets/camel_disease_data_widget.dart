...
import 'camel_disease_textfield_widget.dart';

class CamelDiseaseDataWidget extends StatelessWidget {
  const CamelDiseaseDataWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: GetBuilder<CamelGetDiseaseController>(
          init: CamelGetDiseaseController(),
          builder: (typeCtrl) {
