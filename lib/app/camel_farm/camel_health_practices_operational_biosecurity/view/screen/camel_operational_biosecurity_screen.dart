...
import '../../controller/camel_opertional_biosecurity_send_data_controller.dart';
import '../widgets/camel_operational_biosecurity_widget.dart';

// ignore: must_be_immutable
class CamelHealthPracticesOpertionalBiosecurityScreen extends StatelessWidget {
  CamelHealthPracticesOpertionalBiosecurityScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  "Camel Health practices on farm (Opertional Biosecurity)".tr,
                  style: const TextStyle(
                    color: primaryColor,
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: CamelOpertionalBiosecurityWidget()),
                        ),
                        //!Submit (Next Buttom)
                        GetBuilder<
                                CamelHealthOpertionalBiosecuritySendDataController>(
                            init:
                                CamelHealthOpertionalBiosecuritySendDataController(),
                            builder: (ctrl) {
                              return Align(
                                ...
                                child: GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                                      ...
                                                      if (res == 200) {
                                                        if (click
                                                          ...
                                                          ctrl.sendData(
                                                              context);
                                                          click
                                                              .changeCamelHealthOpertionalClick();
                                                        }
                                                      } else if (res == 401) {
                                                        Get.offAll(() =>
                                                            const LoginScreen());
                                        ...
                                        child:
                                            click.camelHealthOpertionalClick ==
                                                    false
                                                ? Get.locale ==
                                                        const Locale('ar')
                                                    ? SvgPicture.asset(
