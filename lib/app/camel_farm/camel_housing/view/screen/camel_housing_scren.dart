...
import '../../controller/camel_send_housing_data_controller.dart';
import '../widgets/camel_housing_widget.dart';

// ignore: must_be_immutable
class CamelHousingScreen extends StatelessWidget {
  CamelHousingScreen({
    Key? key,
  }) : super(key: key);
                        ...
                        GetBuilder<CurrentLocationController>(
                            ...
                            builder: (location) {
                              return Align(
                                ...
                                child: GetBuilder<
                                        CamelHousingSendDataController>(
                                    init: CamelHousingSendDataController(),
                                    builder: (ctrl) {
                                                          ...
                                                          EndSectioDateService
                                                            ...
                                                            if (res == 200) {
                                                              if (click
                                                                      .camelhouseClick ==
                                                                  false) {
                                                                ctrl.fillCamelHousingAnswerList();
                                                                ctrl.sendCamelHousingData(
                                                                    context);
                                                                click
                                                                    .changeCamelhouseClick();
                                                              }
                                                            } else if (res ==
                                                                401) {
                                                              Get.offAll(() =>
