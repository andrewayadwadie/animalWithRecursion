...
import 'camel_place_sample_widget.dart';
import 'camel_sample_type_widget.dart';
import 'camel_sample_widget.dart';

class CamelListSampleWidget extends StatelessWidget {
  const CamelListSampleWidget({
    Key? key,
    required this.index,
