...
import '../../controller/camel_send_reproduction_data_controller.dart';
import '../widgets/camel_reproduction_widget.dart';

// ignore: must_be_immutable
class CamelReproductionScreen extends StatelessWidget {
  CamelReproductionScreen({Key? key}) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          ...
                          child: GetBuilder<
                                  CamelReproductionSendDataController>(
                              init: CamelReproductionSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                                ...
                                                net
                                                  ...
                                                  if (value) {
                                                    EndSectioDateService
                                                      ...
                                                      if (res == 200) {
                                                        if (click
                                                                .camelReproductionClick ==
                                                            false) {
                                                          ctrl.fillAnswerListWithData();
                                                          ctrl.sendData(
                                                              context);
                                                          click
                                                              .changeCamelReproductionClick();
                                                        }
                                                      } else if (res == 401) {
                                                        Get.offAll(() =>
                                                            const LoginScreen());
                                        ...
                                        child: click.camelReproductionClick ==
                                                false
