...
import '../../controller/camel_send_symptoms_data_controller.dart';
                  ...
                  child: Form(
                    ...
                    child: Stack(
                      children: [
                        ...
                        //!Submit (Next Buttom)
                        GetBuilder<CamelGetSymptomsController>(
                            ...
                            builder: (typeCtrl) {
                              return Align(
                                ...
                                child: GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return GetBuilder<
                                              CamelSendSymptomsController>(
                                          init: CamelSendSymptomsController(),
                                            ...
                                            return GetBuilder<ClickController>(
                                                ...
                                                builder: (click) {
                                                  return InkWell(
                                                    ...
                                                    child: click.camelSymptomsClick ==
                                                            false
                                                        ? Get.locale ==
                                                                const Locale(
                                                                    'ar')
