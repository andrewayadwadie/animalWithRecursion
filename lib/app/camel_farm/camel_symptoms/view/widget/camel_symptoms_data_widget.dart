...
import '../../controller/camel_get_symptoms_controller.dart';
import '../../controller/camel_symptoms_image_picker.dart';
import 'camel_symptoms_notes_textfield_widget.dart';
import 'camel_symptoms_textfield_widget.dart';

// ignore: must_be_immutable
class CamelsymptomsDataWidget extends StatelessWidget {
  const CamelsymptomsDataWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: GetBuilder<CamelGetSymptomsController>(
          init: CamelGetSymptomsController(),
          builder: (typeCtrl) {
                        ...
                        children: [
                          ...
                          if (typeCtrl.choices[index] == true)
                            Container(
                              ...
                              child: GetBuilder<
                                      CamelSymptomsImagePickerController>(
                                  init: CamelSymptomsImagePickerController(
                                      typeCtrl.symptoms),
                                  builder: (imagePick) {
                                    return ListView(
                                      children: [
