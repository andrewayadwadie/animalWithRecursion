...
import '../service/camel_another_type_service.dart';

class AnotherAnimalController extends GetxController {
  @override
  void onInit() {
    super.onInit();
    getEducationCount();
  ...
  dynamic getEducationCount() {
    ...
    CamelAnotherAnimalService.getAnimalType().then((value) {
      if (value.runtimeType == List<AnimalTypeModel>) {
        animalType = value;
