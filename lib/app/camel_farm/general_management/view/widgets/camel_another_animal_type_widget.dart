...
import '../../controller/camel_another_animal_type_controller.dart';
 

class CamelOntherAnimalWidget extends StatelessWidget { 
  const CamelOntherAnimalWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 10),
      child: GetBuilder<AnotherAnimalController>(
          init: AnotherAnimalController( ),
          builder: (controller) {
