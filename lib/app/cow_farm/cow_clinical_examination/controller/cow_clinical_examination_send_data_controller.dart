...
import 'cow_animals_show_symptoms_radio_controller.dart';
import 'cow_clinical_changes_checkbox_controller.dart';
import 'cow_clinical_textfield_controller.dart';
import 'cow_diagnoses_disease_controller.dart';
import 'cow_disease_among_workers_radio_widget.dart';
import 'cow_disease_outbreak_radio_controller.dart';
import 'cow_health_issues_checkbox_controller.dart';
import 'cow_inflammation_site_radio_controller.dart';
import 'cow_miscarriage_time_controller.dart';
import 'cow_sick_animals_treated_controller.dart';
import 'cow_sick_case_radio_controller.dart';
import 'cow_sores_radio_controller.dart';
import 'cow_symptoms_before_abortion_radio_controller.dart';
import 'cow_udder_gangrene_radio_controller.dart';
import 'cow_wounds_radio_controller.dart';

class CowclinicalExaminationSendDataController extends GetxController {
  ...
  CowhealthIssuesCheckboxController healthIssuesCheckboxCtrl =
      Get.put(CowhealthIssuesCheckboxController(choices: [
  ...
  CowSickCaseRadioController sickCaseRadioClr =
      Get.put(CowSickCaseRadioController());

  CowAnimalsShowSymptomsRadioController showSymptomsCtrl =
      Get.put(CowAnimalsShowSymptomsRadioController());
  CowDiseaseAmongWorkersRadioController diseaseAmongWorkers =
      Get.put(CowDiseaseAmongWorkersRadioController());
  CowDiagnosesDiseaseController diagnosesDiseaseCtrl =
      Get.put(CowDiagnosesDiseaseController());
  CowSickAnimalsTreatedController sickAnimalsTreatedCtrl =
      Get.put(CowSickAnimalsTreatedController());
  CowDiseaseOutbreakRadioController diseaseOutbreakCtrl =
      Get.put(CowDiseaseOutbreakRadioController());
//!===========================*=======================*=======================================
  CowInflammationSiteRadioController inflammationSiteRadioCtrl =
      Get.put(CowInflammationSiteRadioController());
  CowUdderGangreneController udderGangreneCtrl =
      Get.put(CowUdderGangreneController());
  CowSoresRadioControllerController soresCtrl =
      Get.put(CowSoresRadioControllerController());
  CowWoundsRadioControllerController woundsCtrl =
      Get.put(CowWoundsRadioControllerController());
//!===========================*=======================*=======================================

  CowSymptomsBeforeAbortionRadioController symmptomsBeforeAbortionCtrl =
      Get.put(CowSymptomsBeforeAbortionRadioController());

  CowMiscarriageTimeController miscarriageTimeCtrl =
      Get.put(CowMiscarriageTimeController());

  CowClinicalChangesCheckboxController clinicalChangesCheckboxCtrl =
      Get.put(CowClinicalChangesCheckboxController(choices: [
  ...
  void fillAnswerListWithData() {
    ...
    //!--------------------------
    //* Radio button
    if (sickCaseRadioClr.charcter == CowSickCaseRadio.yes) {
      sendDataCtrl.addAnswer(id: 229, answer: "");
    } else if (sickCaseRadioClr.charcter == CowSickCaseRadio.no) {
      sendDataCtrl.addAnswer(id: 230, answer: "");
    } else if (sickCaseRadioClr.charcter == CowSickCaseRadio.noAnswer) {
    ...
    //!--------------------------
    //* Radio button
    if (showSymptomsCtrl.charcter == CowAnimalsShowSymptomsRadio.yes) {
      sendDataCtrl.addAnswer(id: 267, answer: "");
    } else if (showSymptomsCtrl.charcter == CowAnimalsShowSymptomsRadio.no) {
      sendDataCtrl.addAnswer(id: 268, answer: "");
    } else if (showSymptomsCtrl.charcter ==
        CowAnimalsShowSymptomsRadio.noAnswer) {
      sendDataCtrl.addAnswer(id: 394, answer: "");
    }
    //!--------------------------
    //* Radio button
    if (diseaseAmongWorkers.charcter == CowDiseaseAmongWorkersRadio.yes) {
      sendDataCtrl.addAnswer(id: 270, answer: "");
    } else if (diseaseAmongWorkers.charcter == CowDiseaseAmongWorkersRadio.no) {
      sendDataCtrl.addAnswer(id: 271, answer: "");
    } else if (diseaseAmongWorkers.charcter ==
        CowDiseaseAmongWorkersRadio.noAnswer) {
    ...
    //!--------------------------
    //* Radio button
    if (diseaseOutbreakCtrl.charcter == CowDiseaseOutbreakRadio.yes) {
      sendDataCtrl.addAnswer(id: 282, answer: "");
    } else if (diseaseOutbreakCtrl.charcter == CowDiseaseOutbreakRadio.no) {
      sendDataCtrl.addAnswer(id: 283, answer: "");
    } else if (diseaseOutbreakCtrl.charcter ==
        CowDiseaseOutbreakRadio.noAnswer) {
  ...
  void fillMastitisAnswers() {
    //!--------------------------
    //* Radio button
    if (inflammationSiteRadioCtrl.charcter == CowInflammationSiteRadio.udder) {
      sendDataCtrl.addAnswer(id: 248, answer: "");
    } else if (inflammationSiteRadioCtrl.charcter ==
        CowInflammationSiteRadio.nipples) {
      sendDataCtrl.addAnswer(id: 249, answer: "");
    } else if (inflammationSiteRadioCtrl.charcter ==
        CowInflammationSiteRadio.noAnswer) {
    ...
    } else if (udderGangreneCtrl.charcter == CowUdderGangrene.no) {
      sendDataCtrl.addAnswer(id: 251, answer: "");
    } else if (udderGangreneCtrl.charcter == CowUdderGangrene.noAnswer) {
      sendDataCtrl.addAnswer(id: 388, answer: "");
    }
    //!--------------------------
    //* Radio button
    if (soresCtrl.charcter == CowSoresRadioController.yes) {
      sendDataCtrl.addAnswer(id: 253, answer: "");
    } else if (soresCtrl.charcter == CowSoresRadioController.no) {
      sendDataCtrl.addAnswer(id: 254, answer: "");
    } else if (soresCtrl.charcter == CowSoresRadioController.noAnswer) {
      sendDataCtrl.addAnswer(id: 389, answer: "");
    }
    //!--------------------------
    //* Radio button
    if (woundsCtrl.charcter == CowWoundsRadioController.yes) {
      sendDataCtrl.addAnswer(id: 255, answer: "");
    } else if (woundsCtrl.charcter == CowWoundsRadioController.no) {
      sendDataCtrl.addAnswer(id: 256, answer: "");
    } else if (woundsCtrl.charcter == CowWoundsRadioController.noAnswer) {
  ...
  void fillMiscarriageAnswers() {
    ...
    if (symmptomsBeforeAbortionCtrl.charcter ==
      ...
      sendDataCtrl.addAnswer(id: 258, answer: "");
        ...
        CowSymptomsBeforeAbortionRadio.no) {
  ...
  void sendData() async {
    ...
    if (res == 200) {
      SharedPreferencesHelper.setCowStatusValue(9);
