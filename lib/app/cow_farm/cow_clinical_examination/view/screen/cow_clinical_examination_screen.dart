...
import '../widgets/cow_clinical_examination_widget.dart';

// ignore: must_be_immutable
class CowclinicalExaminationScreen extends StatelessWidget {
  CowclinicalExaminationScreen({Key? key}) : super(key: key);
  final _formKey = GlobalKey<FormState>();
  CowclinicalExaminationSendDataController sendDataCtrl =
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: CowclinicalExaminationWidget()),
                        ),
                        //!Submit (Next Buttom)
                        Align(
                          ...
                          child: GetBuilder<InternetController>(
                              ...
                              builder: (net) {
                                return InkWell(
                                            ...
                                            if (value) {
                                              EndSectioDateService
                                                ...
                                                if (res == 200) {
                                                  ...
                                                  Get.snackbar(
                                                      "you should add herd first".tr.tr,
                                                      "",
                                                      backgroundColor:
                                                          secondaryColor,
                                  ...
                                  child: click.cowClinicalClick == false
