...
import '../../controller/cow_miscarriage_time_controller.dart';

class CowMiscarriageTimeWidget extends StatelessWidget {
  const CowMiscarriageTimeWidget({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CowMiscarriageTimeController>(
        init: CowMiscarriageTimeController(),
        builder: (controller) {
