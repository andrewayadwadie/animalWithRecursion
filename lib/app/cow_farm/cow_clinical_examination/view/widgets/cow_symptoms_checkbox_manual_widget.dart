...
import '../../controller/cow_clinical_examination_send_data_controller.dart';
import '../../controller/cow_clinical_textfield_controller.dart';
import '../../controller/cow_symptoms_checkbox_manual_controller.dart';
import 'cow_mastitis_form_widget.dart';
import 'cow_miscarriage_form_widget.dart';
import 'cow_symptoms_types_textfield_widget.dart';
 

// ignore: must_be_immutable
class CowSymptomsCheckboxManualWidget extends StatelessWidget {
  CowSymptomsCheckboxManualWidget({Key? key}) : super(key: key);
  CowClinicalTextFieldController clinicalTextFieldCtrl =
      Get.put(CowClinicalTextFieldController());
  CowclinicalExaminationSendDataController sendPopUpDataCtrl =
      Get.put(CowclinicalExaminationSendDataController());
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CowSymptomsCheckboxManualController>(
        init: CowSymptomsCheckboxManualController(),
                                    ...
                                    Align(
                                      ...
                                      child: SizedBox(
                                        height:
                                            MediaQuery.of(context).size.height /
                                                1.97,
                                        child: CowMiscarriageFormWidget(),
                                      ),
                                    ),
                                    Align(
                                        alignment: Alignment.bottomCenter,
