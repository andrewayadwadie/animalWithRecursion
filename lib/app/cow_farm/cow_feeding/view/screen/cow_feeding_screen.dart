...
import '../../controller/cow_send_feeding_data_controller.dart';
import '../widgets/cow_feeding_widget.dart';

// ignore: must_be_immutable
class CowFeedingScreen extends StatelessWidget {
  CowFeedingScreen({Key? key}) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          ...
                          child: GetBuilder<CowFeedingSendDataController>(
                              init: CowFeedingSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.cowFeedingClick == false
