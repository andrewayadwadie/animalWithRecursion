...
import '../../controller/cow_send_general_data_controller.dart';
import '../widgets/cow_general_management_widget.dart';

// ignore: must_be_immutable
class CowGeneralManagementScreen extends StatelessWidget {
  CowGeneralManagementScreen({
    Key? key,
  }) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  "General Management for Cows".tr,
                  style: const TextStyle(
                    color: primaryColor,
                    fontSize: 25,
                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: CowGeneralManagementWidget()),
                        ),
                        //!Submit (Next Buttom)
                        GetBuilder<CowGeneralSendDataController>(
                            init: CowGeneralSendDataController(),
                            builder: (ctrl) {
                              return Align(
                                ...
                                child: GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.cowGeneralClick == false
