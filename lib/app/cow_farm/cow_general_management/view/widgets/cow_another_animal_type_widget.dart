...
import '../../controller/cow_another_animal_type_controller.dart';
 
 

class CowOntherAnimalWidget extends StatelessWidget { 
  const CowOntherAnimalWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 10),
      child: GetBuilder<CowAnotherAnimalController>(
          init: CowAnotherAnimalController( ),
          builder: (controller) {
                              ...
                              builder: (ctx) => controller.loading == true
                                  ...
                                  : SizedBox( 
                                      ...
                                      child: ListView.builder(
                                          itemCount: controller.animalType.length,
                                          itemBuilder: (context, index) {
                                            return InkWell(
                                              onTap: () {
                                                controller.onTapSelected(
                                                    ctx,
                                                    controller.animalType[index].id,
                                                    index);
                                              },
                                              child: Padding(
                                                padding:
