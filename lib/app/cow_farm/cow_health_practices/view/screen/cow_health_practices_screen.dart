...
import '../../controller/cow_send_health_practices_data_controller.dart';
import '../widgets/cow_health_practices_widget.dart';

// ignore: must_be_immutable
class CowHealthPracticesScreen extends StatelessWidget {
  CowHealthPracticesScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  "Cow Health practices on farm (physical biosafety)".tr,
                  style: const TextStyle(
                    color: primaryColor,
                    fontSize: 21,
                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: CowHealthPracticesWidget()),
                        ),
                        //!Submit (Next Buttom)
                        Align(
                        alignment: Get.locale == const Locale('ar')
                          ...
                          child: GetBuilder<
                                  CowHealthPracticesSendDataController>(
                              init: CowHealthPracticesSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.cowHealthClick == false
