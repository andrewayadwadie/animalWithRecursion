...
import '../../controller/cow_opertional_biosecurity_send_data_controller.dart';
import '../widgets/cow_operational_biosecurity_widget.dart';

// ignore: must_be_immutable
class CowHealthPracticesOpertionalBiosecurityScreen extends StatelessWidget {
  CowHealthPracticesOpertionalBiosecurityScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  "Cow Health practices on farm (Opertional Biosecurity)".tr,
                  style: const TextStyle(
                    color: primaryColor,
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: CowOpertionalBiosecurityWidget()),
                        ),
                        //!Submit (Next Buttom)
                        GetBuilder<
                                CowHealthOpertionalBiosecuritySendDataController>(
                            init:
                                CowHealthOpertionalBiosecuritySendDataController(),
                            builder: (ctrl) {
                              return Align(
                                ...
                                child: GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                                ...
                                                net
                                                  ...
                                                  if (value) {
                                                    EndSectioDateService
                                                      ...
                                                      if (res == 200) {
                                                        if (click
                                                                .cowHealthOpertionalClick ==
                                                            false) {
                                                          ctrl.fillAnswerListWithData();
                                                          ctrl.sendData(
                                                              context);
                                                          click
                                                              .changecowHealthOpertionalClick();
                                                        }
                                                      } else if (res == 401) {
                                                        Get.offAll(() =>
                                                            const LoginScreen());
                                        ...
                                        child: click.cowHealthOpertionalClick ==
                                                false
