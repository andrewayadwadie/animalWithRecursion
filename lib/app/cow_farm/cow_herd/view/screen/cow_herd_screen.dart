...
import '../../controller/cow_send_herd_data_controller.dart';
import '../widgets/cow_herd_form_widget.dart';

// ignore: must_be_immutable
class CowHerdScreen extends StatelessWidget {
  CowHerdScreen({
    Key? key,
  }) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          ...
                          child: GetBuilder<CowSendHerdDataController>(
                              init: CowSendHerdDataController(),
                              builder: (ctrl) {
                                        ...
                                        onTap: () async {
                                          if (_formKey.currentState!
                                            ...
                                            net.checkInternet().then((value) {
                                              if (value) {
                                                if (click.cowHerdClick ==
                                                    false) {
                                                  ctrl.sendHerdData(context);
                                                  click.changecowHerdClick();
                                                }
                                              }
                                            });
                                          }
                                        },
                                        child: click.cowHerdClick == false
