...
import '../../controller/cow_send_housing_data_controller.dart';
import '../widgets/cow_housing_widget.dart';

// ignore: must_be_immutable
class CowHousingScreen extends StatelessWidget {
  CowHousingScreen({
    Key? key,
  }) : super(key: key);
                        ...
                        GetBuilder<CurrentLocationController>(
                            ...
                            builder: (location) {
                              ...
                              : Alignment.bottomRight,
                                child: GetBuilder<CowHousingSendDataController>(
                                    init: CowHousingSendDataController(),
                                    builder: (ctrl) {
                                                            ...
                                                            if (res == 200) {
                                                              if (value) {
                                                                if (click
                                                                        .cowhouseClick ==
                                                                    false) {
                                                                  ctrl.fillCowHousingAnswerList();
                                                                  ctrl.sendCowHousingData(
                                                                      context);
                                                                  click
                                                                      .changecowhouseClick();
                                                                }
