...
import '../widgets/cow_immunization_form_widget.dart';
 
class CowImmunizationScreen extends StatelessWidget {
  const CowImmunizationScreen({ Key? key }) : super(key: key);
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: const CowImmunizationFormWidget(),
