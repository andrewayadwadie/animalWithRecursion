...
import '../../controller/cow_immunization_types_controller.dart';

class CowImmunizationFormWidget extends StatelessWidget {
  const CowImmunizationFormWidget({Key? key}) : super(key: key);
              ...
              child: ListView(
                children: [
                  ...
                  if (radio.charcter == CowImmunizationExist.yes)
                    GetBuilder<CowImmunizationTypesController>(
                        init: CowImmunizationTypesController(),
                        builder: (typeCtrl) {
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text(
                                "Cow Immunizations Types :",
                                style: TextStyle(
                                  color: primaryColor,
                                  fontSize: 15,
                                  fontWeight: FontWeight.bold,
                              ...
                              ListTile(
                                title: const Text('Corona Mers For Cows'),
                                leading: Checkbox(
                                  value: typeCtrl.coronaMersForCows,
                                  onChanged: (val) =>
                                      typeCtrl.coronaMersForCowsChange(val),
                                ),
                              ),
                              ListTile(
                                title: const Text('Smallpox For Cows'),
                                leading: Checkbox(
                                  value: typeCtrl.smallpoxForCows,
                                  onChanged: (val) =>
                                      typeCtrl.smallpoxForCowsonChange(val),
                                ),
                              ),
                              ListTile(
