...
import '../services/cow_immunization_service.dart';


class CowGetImmunizationsController extends GetxController {
  @override
  void onInit() {
    super.onInit();
  ...
  dynamic getImmunization({required int animalType}) {
    CowImmunizationService.getImmunization(animalType).then((value) {
