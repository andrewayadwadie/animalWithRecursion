                          ...
                          if (typeCtrl.choices[index] == true)
                            ...
                            GestureDetector(
                                                            ...
                                                            children: [
                                                              CowImmunizationProgramRadioWidget(
                                                                  yesValue:
                                                                      "yes".tr,
                                                                  onChangedYes:
                                                                      (val) => immunizationProgramRadioCtrl.onChange(
                                                                          val ??
                                                                              "yes"
                                                                                  .tr,
                                                                          index),
                                                                    ...
                                                                    return GestureDetector(
                                                                      onTap:
                                                                        ...
                                                                        sendNewImmunizationDataController
                                                                            .addAnswer(
                                                                          immunzationId: typeCtrl
                                                                              .immunization[index]
                                                                              .id,
                                                                          date:
                                                                              "${dateCtrl.date[index].year}-${dateCtrl.date[index].month}-${dateCtrl.date[index].day} ",
                                                                          immunzationGiver: doctorCtrl
                                                                              .immunizationNewDoctorText[index]
                                                                              .value,
                                                                          immunzationWay:
                                                                              editCtrl[index].text,
                                                                          isFullImmunizationProgram: immunizationProgramRadioCtrl.charcter[index] == "yes".tr
                                                                              ? true
                                                                              : false,
                                                                        );
                                ...
                                child: Center(
                                  ...
                                  child:
                                      AutoSizeText("Add Immunization Data".tr,
