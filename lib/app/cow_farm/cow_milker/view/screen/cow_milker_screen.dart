...
import '../../controller/cow_send_milker_data_controller.dart';
import '../widgets/cow_milker_widget.dart';

// ignore: must_be_immutable
class CowMilkerScreen extends StatelessWidget {
  CowMilkerScreen({Key? key}) : super(key: key);
                        ...
                        GetBuilder<CurrentLocationController>(
                            ...
                            builder: (location) {
                              ...
                              : Alignment.bottomRight,
                                child: GetBuilder<CowSendMilkerDataController>(
                                    init: CowSendMilkerDataController(),
                                    builder: (ctrl) {
