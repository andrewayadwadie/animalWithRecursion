...
import '../../controller/cow_send_reproduction_data_controller.dart';
import '../widgets/cow_reproduction_widget.dart';

// ignore: must_be_immutable
class CowReproductionScreen extends StatelessWidget {
  CowReproductionScreen({Key? key}) : super(key: key);
                        ...
                        GetBuilder<CurrentLocationController>(
                            ...
                            builder: (location) {
                              ...
                              : Alignment.bottomRight,
                                child: GetBuilder<
                                        CowReproductionSendDataController>(
                                    init: CowReproductionSendDataController(),
                                    builder: (ctrl) {
                                                      ...
                                                      net
                                                        ...
                                                        if (value) {
                                                          EndSectioDateService
                                                            ...
                                                            if (res == 200) {
                                                              if (click
                                                                      .cowReproductionClick ==
                                                                  false) {
                                                                ctrl.fillAnswerListWithData();
                                                                ctrl.sendData(
                                                                    context);
                                                                click
                                                                    .changecowReproductionClick();
                                                              }
                                                            } else if (res ==
                                                                401) {
                                                              Get.offAll(() =>
