...
class CowSendSymptomsService {
  static Future cowSendSymptomsService({
    required List<CowAddModel> allData,
  }) async {
    ...
    final Uri url = Uri.parse(
        "${apiUrl}Herds/AddHerdSyndromes/${SharedPreferencesHelper.getCamelHerdValue()}");
