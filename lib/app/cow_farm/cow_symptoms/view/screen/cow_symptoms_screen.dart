...
import '../../controller/cow_send_symptoms_data_controller.dart';
import '../widget/cow_symptoms_form_widget.dart';

// ignore: must_be_immutable
class CowSymptomsScreen extends StatelessWidget {
  CowSymptomsScreen({Key? key}) : super(key: key);
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: const CowSymptomsFormWidget()),
                        ),
                        //!Submit (Next Buttom)
                        GetBuilder<CowGetSymptomsController>(
                            ...
                            builder: (typeCtrl) {
                              ...
                              : Alignment.bottomRight,
                                child: GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return GetBuilder<
                                              CowSendSymptomsController>(
                                          init: CowSendSymptomsController(),
