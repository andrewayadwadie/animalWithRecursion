...
import '../../controller/cow_symptoms_image_picker.dart';
import 'cow_symptoms_textfield_widget.dart';

// ignore: must_be_immutable
class CowsymptomsDataWidget extends StatelessWidget {
  const CowsymptomsDataWidget({Key? key}) : super(key: key);
                        ...
                        children: [
                          ...
                          if (typeCtrl.choices[index] == true)
                            Container(
                              ...
                              child: GetBuilder<
                                      CowSymptomsImagePickerController>(
                                  init: CowSymptomsImagePickerController(
                                      typeCtrl.symptoms),
                                  builder: (imagePick) {
                                    return ListView(
                                      children: [
                                        LabelWidget(
                                            label:
                                                "How Many case of this Symptoms ?"
                                                    .tr),
