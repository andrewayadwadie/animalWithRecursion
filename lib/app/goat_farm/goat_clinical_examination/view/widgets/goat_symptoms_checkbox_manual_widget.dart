...
import '../../controller/goat_clinical_examination_send_data_controller.dart';
import '../../controller/goat_clinical_textfield_controller.dart';
import '../../controller/goat_symptoms_checkbox_manual_controller.dart';
import 'goat_mastitis_form_widget.dart';
import 'goat_miscarriage_form_widget.dart';
import 'goat_symptoms_types_textfield_widget.dart';
 
// ignore: must_be_immutable
class GoatSymptomsCheckboxManualWidget extends StatelessWidget {
  GoatSymptomsCheckboxManualWidget({Key? key}) : super(key: key);
  GoatClinicalTextFieldController clinicalTextFieldCtrl =
      Get.put(GoatClinicalTextFieldController());
  GoatclinicalExaminationSendDataController sendPopUpDataCtrl =
      Get.put(GoatclinicalExaminationSendDataController());
  @override
  Widget build(BuildContext context) {
    return GetBuilder<GoatSymptomsCheckboxManualController>(
        init: GoatSymptomsCheckboxManualController(),
                                    ...
                                    Align(
                                      ...
                                      child: SizedBox(
                                        height:
                                            MediaQuery.of(context).size.height /
                                                1.97,
                                        child: GoatMiscarriageFormWidget(),
                                      ),
                                    ),
                                    Align(
                                        alignment: Alignment.bottomCenter,
