...
import '../services/goat_disease_service.dart';

 
class GoatGetDiseaseController extends GetxController {
  @override
  void onInit() {
    super.onInit();
    getDisease(animalType:4);
  }
  ...
  dynamic getDisease({required int animalType}) {
    GoatDiseaseService.getDisease(animalType).then((value) {
