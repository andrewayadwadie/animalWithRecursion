...
class GoatlDiseasesScreen extends StatelessWidget {
  ...
  GoatGetDiseaseController diseaseCtrl = Get.put(GoatGetDiseaseController());
                          ...
                          child: GetBuilder<InternetController>(
                              ...
                              builder: (net) {
                                return InkWell(
                                  ...
                                  child: click.goatFarmDiseaseClick == false
