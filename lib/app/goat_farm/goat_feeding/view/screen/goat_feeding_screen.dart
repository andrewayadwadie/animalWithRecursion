...
import '../../controller/Goat_send_feeding_data_controller.dart';
import '../widgets/goat_feeding_widget.dart';

// ignore: must_be_immutable
class GoatFeedingScreen extends StatelessWidget {
  GoatFeedingScreen({Key? key}) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          ...
                          child: GetBuilder<GoatFeedingSendDataController>(
                              init: GoatFeedingSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.goatFeedingClick == false
