...
import '../../controller/goat_send_health_practices_data_controller.dart';
import '../widgets/goat_health_practices_widget.dart';

// ignore: must_be_immutable
class GoatHealthPracticesScreen extends StatelessWidget {
  GoatHealthPracticesScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  "Goat Health practices on farm (physical biosafety)".tr,
                  style: const TextStyle(
                    color: primaryColor,
                    fontSize: 21,
                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: GoatHealthPracticesWidget()),
                        ),
                        //!Submit (Next Buttom)
                        Align(
                          ...
                          child: GetBuilder<
                                  GoatHealthPracticesSendDataController>(
                              init: GoatHealthPracticesSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.goatHealthClick == false
