...
import '../../controller/goat_opertional_biosecurity_send_data_controller.dart';
import '../widgets/goat_operational_biosecurity_widget.dart';

// ignore: must_be_immutable
class GoatHealthPracticesOpertionalBiosecurityScreen extends StatelessWidget {
  GoatHealthPracticesOpertionalBiosecurityScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  "Goat Health practices on farm (Opertional Biosecurity)".tr,
                  style: const TextStyle(
                    color: primaryColor,
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: GoatOpertionalBiosecurityWidget()),
                        ),
                        //!Submit (Next Buttom)
                        GetBuilder<
                                GoatHealthOpertionalBiosecuritySendDataController>(
                            init:
                                GoatHealthOpertionalBiosecuritySendDataController(),
                            builder: (ctrl) {
                              return Align(
                                ...
                                child: GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                                ...
                                                net
                                                  ...
                                                  if (value) {
                                                    EndSectioDateService
                                                      ...
                                                      if (res == 200) {
                                                        if (click
                                                                .goatHealthOpertionalClick ==
                                                            false) {
                                                          ctrl.fillAnswerListWithData();
                                                          ctrl.sendData(
                                                              context);
                                                          click
                                                              .changegoatHealthOpertionalClick();
                                                        }
                                                      } else if (res == 401) {
                                                        Get.offAll(() =>
                                                            const LoginScreen());
                                        ...
                                        child:
                                            click.goatHealthOpertionalClick ==
                                                    false
