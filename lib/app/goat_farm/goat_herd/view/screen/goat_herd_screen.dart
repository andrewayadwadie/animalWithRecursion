...
import '../../controller/goat_send_herd_data_controller.dart';
import '../widgets/goat_herd_form_widget.dart';

// ignore: must_be_immutable
class GoatHerdScreen extends StatelessWidget {
  GoatHerdScreen({
    Key? key,
  }) : super(key: key);
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: const GoatHerdFormWidget()),
                        ),
                        //!Submit (Next Buttom)
                        Align(
                          ...
                          child: GetBuilder<GoatSendHerdDataController>(
                              init: GoatSendHerdDataController(),
                              builder: (ctrl) {
                                        ...
                                        onTap: () async {
                                          if (_formKey.currentState!
                                            ...
                                            net.checkInternet().then((value) {
                                              if (value) {
                                                if (click.goatHerdClick ==
                                                    false) {
                                                  ctrl.sendHerdData(context);
                                                  click.changegoatHerdClick();
                                                }
                                              }
                                            });
                                          }
                                        },
                                        child: click.goatHerdClick == false
