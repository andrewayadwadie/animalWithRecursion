...
import '../../controller/goat_herd_dynasty_controller.dart';
 

class GoatDynastyWidget extends StatelessWidget {
  const GoatDynastyWidget({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<GoatHerdDynastyController>(
        init: GoatHerdDynastyController(goatHerdId: 4),
        builder: (controller) {
