...
import '../../controller/goat_herd_form_controller.dart';
import 'goat_dynasty_widget.dart';
import 'goat_herd_textfield_widget.dart';

class GoatHerdFormWidget extends StatelessWidget {
  const GoatHerdFormWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<GoatHerdFormController>(
        init: GoatHerdFormController(),
        builder: (ctrl) {
          return ListView(
            children: [
              //! Number of Animals in Farm
              LabelWidget(label: "The total number of animals on the farm".tr),
              GoatHerdTextFieldWidget(
              ...
              //!dynasty
              LabelWidget(label: "Goat Dynasty".tr),
              const GoatDynastyWidget(),
