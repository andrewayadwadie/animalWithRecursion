...
import '../../controller/goat_send_housing_data_controller.dart';
import '../widgets/goat_housing_widget.dart';

// ignore: must_be_immutable
class GoatHousingScreen extends StatelessWidget {
  GoatHousingScreen({
    Key? key,
  }) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          ...
                          child: GetBuilder<GoatHousingSendDataController>(
                              init: GoatHousingSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                                    ...
                                                    EndSectioDateService
                                                      ...
                                                      if (res == 200) {
                                                        if (click
                                                                .goathouseClick ==
                                                            false) {
                                                          ctrl.fillGoatHousingAnswerList();
                                                          ctrl.sendGoatHousingData(
                                                              context);
                                                          click
                                                              .changegoathouseClick();
                                                        }
                                                      } else if (res == 401) {
                                                        Get.offAll(() =>
                                                            const LoginScreen());
                                        ...
                                        child: click.goathouseClick == false
