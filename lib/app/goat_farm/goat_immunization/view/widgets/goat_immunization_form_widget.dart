...
import '../../controller/goat_immunization_types_controller.dart';

class GoatImmunizationFormWidget extends StatelessWidget {
  const GoatImmunizationFormWidget({Key? key}) : super(key: key);
              ...
              child: ListView(
                children: [
                  ...
                  if (radio.charcter == GoatImmunizationExist.yes)
                    GetBuilder<GoatImmunizationTypesController>(
                        init: GoatImmunizationTypesController(),
                        builder: (typeCtrl) {
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text(
                                "Goat Immunizations Types :",
                                style: TextStyle(
                                  color: primaryColor,
                                  fontSize: 15,
                                  fontWeight: FontWeight.bold,
                              ...
                              ListTile(
                                title: const Text('Corona Mers For Goats'),
                                leading: Checkbox(
                                  value: typeCtrl.coronaMersForGoats,
                                  onChanged: (val) =>
                                      typeCtrl.coronaMersForGoatsChange(val),
                                ),
                              ),
                              ListTile(
                                title: const Text('Smallpox For Goats'),
                                leading: Checkbox(
                                  value: typeCtrl.smallpoxForGoats,
                                  onChanged: (val) =>
                                      typeCtrl.smallpoxForGoatsonChange(val),
                                ),
                              ),
                              ListTile(
