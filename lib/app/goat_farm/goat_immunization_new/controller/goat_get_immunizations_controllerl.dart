...
import '../services/goat_immunization_service.dart';
 

class GoatGetImmunizationsController extends GetxController {
  @override
  void onInit() {
    super.onInit();
  ...
  dynamic getImmunization({required int animalType}) {
    GoatImmunizationService.getImmunization(animalType).then((value) {
