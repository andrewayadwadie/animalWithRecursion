...
import '../../controller/goat_send_milker_data_controller.dart';
import '../widgets/goat_milker_widget.dart';

// ignore: must_be_immutable
class GoatMilkerScreen extends StatelessWidget {
  GoatMilkerScreen({Key? key}) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          ...
                          child: GetBuilder<GoatSendMilkerDataController>(
                              init: GoatSendMilkerDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.goatMilkerClick == false
