...
import '../../controller/goat_send_reproduction_data_controller.dart';
import '../widgets/goat_reproduction_widget.dart';

// ignore: must_be_immutable
class GoatReproductionScreen extends StatelessWidget {
  GoatReproductionScreen({Key? key}) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          ...
                          child: GetBuilder<GoatReproductionSendDataController>(
                              init: GoatReproductionSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                                ...
                                                net
                                                  ...
                                                  if (value) {
                                                    EndSectioDateService
                                                      ...
                                                      if (res == 200) {
                                                        if (click
                                                                .goatReproductionClick ==
                                                            false) {
                                                          ctrl.fillAnswerListWithData();
                                                          ctrl.sendData(
                                                              context);
                                                          click
                                                              .changegoatReproductionClick();
                                                        }
                                                      } else if (res == 401) {
                                                        Get.offAll(() =>
                                                            const LoginScreen());
                                        ...
                                        child: click.goatReproductionClick ==
                                                false
