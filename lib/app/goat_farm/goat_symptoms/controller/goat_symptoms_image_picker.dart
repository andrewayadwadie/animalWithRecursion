...
class GoatSymptomsImagePickerController extends GetxController {
  final List<dynamic> symptomsList;
  List<File> imagesList = [];
  List<List<File>> allImagesList = [];
  GoatGetImageListData getImageListDataCtrl = Get.put(GoatGetImageListData());
  GoatSymptomsImagePickerController(this.symptomsList);
  @override
  void onInit() {
    super.onInit();
