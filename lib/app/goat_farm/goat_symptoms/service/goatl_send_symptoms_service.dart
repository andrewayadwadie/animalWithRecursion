...
class GoatSendSymptomsService {
  static Future goatSendSymptomsService({
    required List<GoatAddModel> allData,
  }) async {
    ...
    final Uri url = Uri.parse(
        "${apiUrl}Goats/AddGoatSyndromes/${SharedPreferencesHelper.getGoatHerdValue()}");
