...
import '../../../../Goat_farm/Goat_symptoms/view/widget/Goat_symptoms_notes_textfield_widget.dart';
import '../../../../shared_widgets/custom_loader.dart';
import '../../../../shared_widgets/label_widget.dart';
import '../../controller/goat_get_symptoms_controller.dart';
import '../../controller/goat_symptoms_image_picker.dart';
import 'goat_symptoms_textfield_widget.dart';
 
// ignore: must_be_immutable
class GoatsymptomsDataWidget extends StatelessWidget {
  const GoatsymptomsDataWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: GetBuilder<GoatGetSymptomsController>(
                        ...
                        children: [
                          ...
                          if (typeCtrl.choices[index] == true)
                            Container(
                              ...
                              child: GetBuilder<
                                      GoatSymptomsImagePickerController>(
                                  init: GoatSymptomsImagePickerController(
                                      typeCtrl.symptoms),
                                  builder: (imagePick) {
                                    return ListView(
                                      children: [
                                        ...
                                        GoatSymptomsTextFieldWidget(
                                          ...
                                          title: "How Many case of this Symptoms ?".tr,
                                        ),
