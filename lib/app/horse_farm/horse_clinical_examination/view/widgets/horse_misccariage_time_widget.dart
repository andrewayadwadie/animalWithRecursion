...
import '../../controller/horse_miscarriage_time_controller.dart';

class HorseMiscarriageTimeWidget extends StatelessWidget {
  const HorseMiscarriageTimeWidget({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<HorseMiscarriageTimeController>(
        init: HorseMiscarriageTimeController(),
        builder: (controller) {
