...
import '../../controller/horse_clinical_examination_send_data_controller.dart';
import '../../controller/horse_clinical_textfield_controller.dart';
import '../../controller/horse_symptoms_checkbox_manual_controller.dart';
import 'horse_mastitis_form_widget.dart';
import 'horse_miscarriage_form_widget.dart';
import 'horse_symptoms_types_textfield_widget.dart';

// ignore: must_be_immutable
class HorseSymptomsCheckboxManualWidget extends StatelessWidget {
  HorseSymptomsCheckboxManualWidget({Key? key}) : super(key: key);
  HorseClinicalTextFieldController clinicalTextFieldCtrl =
      Get.put(HorseClinicalTextFieldController());
  HorseclinicalExaminationSendDataController sendPopUpDataCtrl =
      Get.put(HorseclinicalExaminationSendDataController());
  @override
  Widget build(BuildContext context) {
    return GetBuilder<HorseSymptomsCheckboxManualController>(
        init: HorseSymptomsCheckboxManualController(),
                                    ...
                                    Align(
                                      ...
                                      child: SizedBox(
                                        height:
                                            MediaQuery.of(context).size.height /
                                                1.97,
                                        child: HorseMiscarriageFormWidget(),
                                      ),
                                    ),
                                    Align(
                                        alignment: Alignment.bottomCenter,
