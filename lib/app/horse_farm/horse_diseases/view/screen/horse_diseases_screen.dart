...
class HorseDiseasesScreen extends StatelessWidget {
  ...
  HorseGetDiseaseController diseaseCtrl = Get.put(HorseGetDiseaseController());
                          ...
                          child: GetBuilder<InternetController>(
                              ...
                              builder: (net) {
                                return InkWell(
                                        ...
                                        net.checkInternet().then((value) {
                                          if (value) {
                                            EndSectioDateService
                                              ...
                                              if (res == 200) {
                                                if (click
                                                        .horseFarmDiseaseClick ==
                                                    false) {
                                                  diseaseDataCtrl.addAnswer(
                                                    diseaseCtrl.disease,
                                                    diseaseCtrl.textEditCtrl,
                                                  );
                                                  log("data is :${diseaseDataCtrl.answers}");
                                  ...
                                  child: click.horseFarmDiseaseClick == false
