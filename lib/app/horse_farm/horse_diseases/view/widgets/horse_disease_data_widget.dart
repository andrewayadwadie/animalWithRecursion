...
import '../../controller/horse_get_disease_controller.dart';
import 'horse_disease_textfield_widget.dart';

class HorseDiseaseDataWidget extends StatelessWidget {
  const HorseDiseaseDataWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: GetBuilder<HorseGetDiseaseController>(
          init: HorseGetDiseaseController(),
          builder: (typeCtrl) {
