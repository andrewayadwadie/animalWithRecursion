...
import '../../controller/horse_send_feeding_data_controller.dart';
import '../widgets/horse_feeding_widget.dart';

// ignore: must_be_immutable
class HorseFeedingScreen extends StatelessWidget {
  HorseFeedingScreen({Key? key}) : super(key: key);
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: const HorseFeedingWidget()),
                        ),
                        //!Submit (Next Buttom)
                        GetBuilder<CurrentLocationController>(
                            ...
                            builder: (location) {
                              var getBuilder = GetBuilder<
                                      HorseFeedingSendDataController>(
                                  init: HorseFeedingSendDataController(),
                                  builder: (ctrl) {
