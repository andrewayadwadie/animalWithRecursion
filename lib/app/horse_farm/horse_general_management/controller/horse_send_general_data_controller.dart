...
import 'horse_another_animal_type_controller.dart';
...
class HorseGeneralSendDataController extends GetxController {
  ...
  HorseWithAnimalsController withAnimalsCtrl =
      Get.put(HorseWithAnimalsController());
  HorseAnimalExistController animalExistCtrl =
      Get.put(HorseAnimalExistController());

  HorseAnotherAnimalController anotherAnimalCtrl =
      Get.put(HorseAnotherAnimalController());
...
//!--------------------------
  ...
  void sendData(context) async {
    ...
    if (res == 200) {
      SharedPreferencesHelper.setHorseStatusValue(1);
