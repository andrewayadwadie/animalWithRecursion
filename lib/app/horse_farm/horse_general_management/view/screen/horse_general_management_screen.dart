...
import '../../controller/horse_send_general_data_controller.dart';
import '../widgets/horse_general_management_widget.dart';

// ignore: must_be_immutable
class HorseGeneralManagementScreen extends StatelessWidget {
  HorseGeneralManagementScreen({
    Key? key,
  }) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  "General Management for Horses".tr,
                  style: const TextStyle(
                    color: primaryColor,
                    fontSize: 25,
                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: HorseGeneralManagementWidget()),
                        ),
                        //!Submit (Next Buttom)
                        GetBuilder<HorseGeneralSendDataController>(
                            init: HorseGeneralSendDataController(),
                            builder: (ctrl) {
                              return Align(
                                ...
                                child: GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.horseGeneralClick == false
