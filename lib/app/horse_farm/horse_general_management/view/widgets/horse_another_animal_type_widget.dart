...
import '../../controller/horse_another_animal_type_controller.dart';

class HorseOntherAnimalWidget extends StatelessWidget {
  const HorseOntherAnimalWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 10),
      child: GetBuilder<HorseAnotherAnimalController>(
          init: HorseAnotherAnimalController(),
          builder: (controller) {
