...
import '../../controller/horse_send_health_practices_data_controller.dart';
import '../widgets/horse_health_practices_widget.dart';

// ignore: must_be_immutable
class HorseHealthPracticesScreen extends StatelessWidget {
  HorseHealthPracticesScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  "Horse Health practices on farm (physical biosafety)".tr,
                  style: const TextStyle(
                    color: primaryColor,
                    fontSize: 21,
                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: HorseHealthPracticesWidget()),
                        ),
                        //!Submit (Next Buttom)
                        Align(
                          ...
                          child: GetBuilder<
                                  HorseHealthPracticesSendDataController>(
                              init: HorseHealthPracticesSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.horseHealthClick == false
