...
import '../../controller/horse_opertional_biosecurity_send_data_controller.dart';
import '../widgets/horse_operational_biosecurity_widget.dart';

// ignore: must_be_immutable
class HorseHealthPracticesOpertionalBiosecurityScreen extends StatelessWidget {
  HorseHealthPracticesOpertionalBiosecurityScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  "Horse Health practices on farm (Opertional Biosecurity)".tr,
                  style: const TextStyle(
                    color: primaryColor,
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: HorseOpertionalBiosecurityWidget()),
                        ),
                        //!Submit (Next Buttom)
                        GetBuilder<
                                HorseHealthOpertionalBiosecuritySendDataController>(
                            init:
                                HorseHealthOpertionalBiosecuritySendDataController(),
                            builder: (ctrl) {
                              return Align(
                                ...
                                child: GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                                    ...
                                                    EndSectioDateService
                                                      ...
                                                      if (res == 200) {
                                                        if (click
                                                          ...
                                                          click
                                                              .changehorseHealthOpertionalClick();
                                                        }
                                                      } else if (res == 401) {
                                                        Get.offAll(() =>
                                                            const LoginScreen());
                                        ...
                                        child:
                                            click.horseHealthOpertionalClick ==
                                                    false
