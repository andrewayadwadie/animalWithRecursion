...
import '../../controller/horse_send_housing_data_controller.dart';
import '../widgets/horse_housing_widget.dart';

// ignore: must_be_immutable
class HorseHousingScreen extends StatelessWidget {
  HorseHousingScreen({
    Key? key,
  }) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          ...
                          child: GetBuilder<HorseHousingSendDataController>(
                              init: HorseHousingSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                                    ...
                                                    EndSectioDateService
                                                      ...
                                                      if (res == 200) {
                                                        if (click
                                                                .horsehouseClick ==
                                                            false) {
                                                          ctrl.fillHorseHousingAnswerList();
                                                          ctrl.sendHorseHousingData(
                                                              context);
                                                          click
                                                              .changehorsehouseClick();
                                                        }
                                                      } else if (res == 401) {
                                                        Get.offAll(() =>
                                                            const LoginScreen());
                                        ...
                                        child: click.horsehouseClick == false
