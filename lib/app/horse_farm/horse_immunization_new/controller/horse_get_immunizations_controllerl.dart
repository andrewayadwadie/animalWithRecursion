...
import '../services/horse_immunization_service.dart';


class HorseGetImmunizationsController extends GetxController {
  @override
  void onInit() {
    super.onInit();
    getImmunization(animalType: 5);
  }
  ...
  dynamic getImmunization({required int animalType}) {
    HorseImmunizationService.getImmunization(animalType).then((value) {
