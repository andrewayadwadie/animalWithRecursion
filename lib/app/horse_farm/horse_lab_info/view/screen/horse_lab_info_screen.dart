...
import '../widgets/horse_lab_info_widget.dart';

// ignore: must_be_immutable
class HorseLabInfoScreen extends StatelessWidget {
  HorseLabInfoScreen({Key? key}) : super(key: key);
                  ...
                  child: Form(
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: const HorseLabInfoWidget()),
                        ),
                        //!Submit (Next Buttom)
                        Align(
                      alignment: Get.locale == const Locale('ar')
                          ...
                          child: GetBuilder<HorseLabInfoController>(
                                ...
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.horseLabClick == false
