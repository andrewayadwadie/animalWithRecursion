...
import 'horse_list_sample_widget.dart';

class HorseLabInfoWidget extends StatelessWidget {
  const HorseLabInfoWidget({Key? key}) : super(key: key);
