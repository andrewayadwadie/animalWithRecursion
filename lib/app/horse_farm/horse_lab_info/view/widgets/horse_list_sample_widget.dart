...
import 'horse_place_sample_widget.dart';
import 'horse_sample_type_widget.dart';
import 'horse_sample_widget.dart';

class HorseListSampleWidget extends StatelessWidget {
  const HorseListSampleWidget({
    Key? key,
    required this.index,
