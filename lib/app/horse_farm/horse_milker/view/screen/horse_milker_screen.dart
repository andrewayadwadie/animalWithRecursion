...
import '../../controller/horse_send_milker_data_controller.dart';
import '../widgets/horse_milker_widget.dart';

// ignore: must_be_immutable
class HorseMilkerScreen extends StatelessWidget {
  HorseMilkerScreen({Key? key}) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                       ...
                       alignment: Get.locale == const Locale('ar')
                          ...
                          child: GetBuilder<HorseSendMilkerDataController>(
                              init: HorseSendMilkerDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.horseMilkerClick == false
