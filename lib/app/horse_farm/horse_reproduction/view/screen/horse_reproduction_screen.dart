...
import '../../controller/horse_send_reproduction_data_controller.dart';
import '../widgets/horse_reproduction_widget.dart';

// ignore: must_be_immutable
class HorseReproductionScreen extends StatelessWidget {
  HorseReproductionScreen({Key? key}) : super(key: key);
              ...
              Expanded(
                ...
                padding: EdgeInsets.symmetric(
                  ...
                  alignment: Get.locale == const Locale('ar')
                          ...
                          child: GetBuilder<
                                  HorseReproductionSendDataController>(
                              init: HorseReproductionSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.horseReproductionClick ==
                                                false
