...
import '../services/sheep_disease_service.dart';

 
class SheepGetDiseaseController extends GetxController {
  @override
  void onInit() {
    super.onInit();
    getDisease(animalType: 3);
  }
  ...
  dynamic getDisease({required int animalType}) {
    SheepDiseaseService.getDisease(animalType).then((value) {
