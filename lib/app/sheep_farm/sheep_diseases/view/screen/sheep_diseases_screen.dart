...
class SheepDiseasesScreen extends StatelessWidget {
  ...
  SheepGetDiseaseController diseaseCtrl = Get.put(SheepGetDiseaseController());
                          ...
                          child: GetBuilder<InternetController>(
                              ...
                              builder: (net) {
                                return InkWell(
                                  ...
                                  child: click.sheepFarmDiseaseClick == false
