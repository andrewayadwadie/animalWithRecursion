...
import '../../controller/sheep_send_feeding_data_controller.dart';
import '../widgets/sheep_feeding_widget.dart';

// ignore: must_be_immutable
class SheepFeedingScreen extends StatelessWidget {
  SheepFeedingScreen({Key? key}) : super(key: key);
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: const SheepFeedingWidget()),
                        ),
                        //!Submit (Next Buttom)
                        Align(
                          ...
                          child: GetBuilder<SheepFeedingSendDataController>(
                              init: SheepFeedingSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.sheepFeedingClick == false
