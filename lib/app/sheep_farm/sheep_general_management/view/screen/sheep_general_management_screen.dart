...
import '../../controller/sheep_send_general_data_controller.dart';
import '../widgets/sheep_general_management_widget.dart';

// ignore: must_be_immutable
class SheepGeneralManagementScreen extends StatelessWidget {
  SheepGeneralManagementScreen({
    Key? key,
  }) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  "General Management for Sheeps".tr,
                  style: const TextStyle(
                    color: primaryColor,
                    fontSize: 25,
                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: SheepGeneralManagementWidget()),
                        ),
                        //!Submit (Next Buttom)
                        GetBuilder<SheepGeneralSendDataController>(
                            init: SheepGeneralSendDataController(),
                            builder: (ctrl) {
                              return Align(
                                ...
                                child: GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.sheepGeneralClick == false
