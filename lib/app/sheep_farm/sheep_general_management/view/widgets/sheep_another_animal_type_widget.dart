...
import '../../controller/sheep_another_animal_type_controller.dart';

class SheepOntherAnimalWidget extends StatelessWidget {
  const SheepOntherAnimalWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 10),
      child: GetBuilder<SheepAnotherAnimalController>(
          init: SheepAnotherAnimalController(),
          builder: (controller) {
