...
import '../../controller/sheep_send_health_practices_data_controller.dart';
import '../widgets/sheep_health_practices_widget.dart';

// ignore: must_be_immutable
class SheepHealthPracticesScreen extends StatelessWidget {
  SheepHealthPracticesScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  "Sheep Health practices on farm (physical biosafety)".tr,
                  style: const TextStyle(
                    color: primaryColor,
                    fontSize: 21,
                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                              ...
                              child: SheepHealthPracticesWidget()),
                        ),
                        //!Submit (Next Buttom)
                        Align(
                        alignment: Get.locale == const Locale('ar')
                          ...
                          child: GetBuilder<
                                  SheepHealthPracticesSendDataController>(
                              init: SheepHealthPracticesSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                        ...
                                        child: click.sheepHealthClick == false
