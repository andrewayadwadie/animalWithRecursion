...
import '../../controller/sheep_antibiotics_type_controller.dart';

class SheepAntibioticsTypeWidget extends StatelessWidget {
  const SheepAntibioticsTypeWidget({ Key? key }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<SheepAntibioticsTypeController>(
        init: SheepAntibioticsTypeController(),
        builder: (controller) {
