...
import '../../controller/sheep_send_housing_data_controller.dart';
import '../widgets/sheep_housing_widget.dart';

// ignore: must_be_immutable
class SheepHousingScreen extends StatelessWidget {
  SheepHousingScreen({
    Key? key,
  }) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          ...
                          child: GetBuilder<SheepHousingSendDataController>(
                              init: SheepHousingSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                                    ...
                                                    EndSectioDateService
                                                      ...
                                                      if (res == 200) {
                                                        if (click
                                                                .sheepFeedingClick ==
                                                            false) {
                                                          ctrl.fillSheepHousingAnswerList();
                                                          ctrl.sendSheepHousingData(
                                                              context);
                                                          click
                                                              .changesheephouseClick();
                                                        }
                                                      } else if (res == 401) {
                                                        Get.offAll(() =>
                                                            const LoginScreen());
                                        ...
                                        child: click.sheephouseClick == false
