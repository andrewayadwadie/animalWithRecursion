...
import '../../controller/sheep_immunization_types_controller.dart';

class SheepImmunizationFormWidget extends StatelessWidget {
  const SheepImmunizationFormWidget({Key? key}) : super(key: key);
              ...
              child: ListView(
                children: [
                  ...
                  if (radio.charcter == SheepImmunizationExist.yes)
                    GetBuilder<SheepImmunizationTypesController>(
                        init: SheepImmunizationTypesController(),
                        builder: (typeCtrl) {
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text(
                                "Sheep Immunizations Types :",
                                style: TextStyle(
                                  color: primaryColor,
                                  fontSize: 15,
                                  fontWeight: FontWeight.bold,
                              ...
                              ListTile(
                                title: const Text('Corona Mers For Sheeps'),
                                leading: Checkbox(
                                  value: typeCtrl.coronaMersForSheeps,
                                  onChanged: (val) =>
                                      typeCtrl.coronaMersForSheepsChange(val),
                                ),
                              ),
                              ListTile(
                                title: const Text('Smallpox For Sheeps'),
                                leading: Checkbox(
                                  value: typeCtrl.smallpoxForSheeps,
                                  onChanged: (val) =>
                                      typeCtrl.smallpoxForSheepsonChange(val),
                                ),
                              ),
                              ListTile(
