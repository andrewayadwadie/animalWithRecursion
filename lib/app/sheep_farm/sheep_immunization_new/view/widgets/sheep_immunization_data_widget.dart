...
import '../../controller/sheep_get_immunizations_controllerl.dart';
import '../../controller/sheep_immunization_new_date_controller.dart';
import '../../controller/sheep_immunization_new_doctroe_controller.dart';
import '../../controller/sheep_immunization_program_raio_controller.dart';
...
import 'sheep_immunization_new_doctor_widget.dart';
import 'sheep_immunization_program_radio_widget.dart';
import 'sheep_immunization_textfield_widget.dart';
 
 

// ignore: must_be_immutable
class SheepImmunizationDataWidget extends StatelessWidget {
  SheepImmunizationDataWidget({Key? key}) : super(key: key);
  ...
  SheepSendNewImmunizationDataController sendNewImmunizationDataController =
      ...
      SheepImmunizationWayTextController wayCtrl = Get.put(SheepImmunizationWayTextController())  ;
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: GetBuilder<SheepGetImmunizationsController>(
          init: SheepGetImmunizationsController(),
          builder: (typeCtrl) {
                                ...
                                GestureDetector(
                                    onTap: () {
                                      showModalBottomSheet(
                                          ...
                                          builder: (ctx) {
                                            return GetBuilder<
                                                    SheepImmunizationProgramRadioController>(
                                                init:
                                                    SheepImmunizationProgramRadioController(
                                                  ...
                                                  return SizedBox(
                                                    ...
                                                    child: ListView(
                                                      children: [
                                                        ...
                                                        SheepImmunizationNewTextFieldWidget(
                                                        ...
                                                        GetBuilder<
                                                                SheepImmunizationNewDateController>(
                                                            init: SheepImmunizationNewDateController(
                                                                typeCtrl
                                                                    .immunization),
                                                            builder: (dateCtrl) {
                                                              return Column(
                                                                crossAxisAlignment:
                                                                    CrossAxisAlignment
                                                                        .start,
                                                                children: [
                                                                  SheepImmunizationProgramRadioWidget(
                                                                      yesValue:
                                                                          "yes".tr,
                                                                      onChangedYes: (val) =>
                                                                  ...
                                                                  //! Doctors
                                                                  SheepImmunizationNewDoctorWidget(
                                                                    list: typeCtrl
                                                                        .immunization,
                                                                    listIndex:
                                                                        index,
                                                                  ...
                                                                  GetBuilder<
                                                                          SheepImmunizationNewDoctorController>(
                                                                      init: SheepImmunizationNewDoctorController(
                                                                          typeCtrl
                                                                              .immunization),
                                                                      builder:
                                                                          (doctorCtrl) {
