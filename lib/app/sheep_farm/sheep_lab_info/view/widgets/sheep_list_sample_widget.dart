...
import 'sheep_place_sample_widget.dart';
import 'sheep_sample_type_widget.dart';
import 'sheep_sample_widget.dart';
 
 

class SheepListSampleWidget extends StatelessWidget {
  const SheepListSampleWidget({
    Key? key,
    required this.index,
              ...
              child: Column(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                        LabelWidget(
                          label: "What is the send sample date ?".tr),
                      GestureDetector(
                        onTap: () {
