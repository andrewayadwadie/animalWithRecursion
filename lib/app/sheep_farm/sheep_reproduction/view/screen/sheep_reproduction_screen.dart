...
import '../../controller/sheep_send_reproduction_data_controller.dart';
import '../widgets/sheep_reproduction_widget.dart';

// ignore: must_be_immutable
class SheepReproductionScreen extends StatelessWidget {
  SheepReproductionScreen({Key? key}) : super(key: key);
                      ...
                      children: [
                        ...
                        Align(
                         alignment: Get.locale == const Locale('ar')
                          ...
                          child: GetBuilder<
                                  SheepReproductionSendDataController>(
                              init: SheepReproductionSendDataController(),
                              builder: (ctrl) {
                                return GetBuilder<InternetController>(
                                    ...
                                    builder: (net) {
                                      return InkWell(
                                                ...
                                                net
                                                  ...
                                                  if (value) {
                                                    EndSectioDateService
                                                      ...
                                                      if (res == 200) {
                                                        if (click
                                                                .sheepReproductionClick ==
                                                            false) {
                                                          ctrl.fillAnswerListWithData();
                                                          ctrl.sendData(
                                                              context);
                                                          click
                                                              .changesheepReproductionClick();
                                                        }
                                                      } else if (res == 401) {
                                                        Get.offAll(() =>
                                                            const LoginScreen());
                                        ...
                                        child: click.sheepReproductionClick ==
                                                false
