...
import '../../controller/sheep_get_symptoms_controller.dart';
import '../../controller/sheep_symptoms_image_picker.dart';
import 'sheep_symptoms_textfield_widget.dart';
 
// ignore: must_be_immutable
class SheepsymptomsDataWidget extends StatelessWidget {
  const SheepsymptomsDataWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: GetBuilder<SheepGetSymptomsController>(
          init: SheepGetSymptomsController(),
          builder: (typeCtrl) {
                        ...
                        children: [
                          ...
                          if (typeCtrl.choices[index] == true)
                            Container(
                              ...
                              child: GetBuilder<
                                      SheepSymptomsImagePickerController>(
                                  init: SheepSymptomsImagePickerController(
                                      typeCtrl.symptoms),
                                  builder: (imagePick) {
                                    return ListView(
                                      children: [
